/*
 *  Output numeric provisioning implementation.
 *
 * (C)2021-2024 St(u)dio of Computer Games
 */

#ifndef __MESH_PROVISIONEE_OUTPUT_NUMERIC_H_
#define __MESH_PROVISIONEE_OUTPUT_NUMERIC_H_
 ...
 *                            procedure.
 * @param[in] oob_output_size Maximum size of Numeric Output OOB supported.
 *
...
#endif /* __MESH_PROVISIONEE_H_OUTPUT_NUMERIC_ */
